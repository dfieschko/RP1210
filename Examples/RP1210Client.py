...
client.setVendor("DGDPA5MA")

# connect to adapter
client.resetDevice()  # ? reallow connection?
...
J1939_broadcast_timing = client.setJ1939InterpacketTime(0x11111111)  # ?
...
# disallow_conn = client.disallowConnections()  # ? re-allow?
